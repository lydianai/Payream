...
```bash
git remote add encore encore://virtual-pos-website-xewi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/virtual-pos-website-xewi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/virtual-pos-website-xewi/settings/integrations/github)
